...
@Component({
  ...
  providers: [
    CollectionService,
    { provide: 'API_SERVICE', useValue: 'employees/list' },
    CommonApiService,
  ],

})
export class ListComponent extends CollectionComponent<Employees> {
  TRANSLATE_KEY=''
  constructor(
    router: Router,
    location: Location,
    api: CommonApiService,
    service: CollectionService<Employees>,
    private toastr: ToastrService,
    private route: ActivatedRoute,
    private apiAuth: AuthenticationApiService,
    @Inject('AuthService')
    public authService: ModelService<Employees>,
    @Inject('MenuService')
